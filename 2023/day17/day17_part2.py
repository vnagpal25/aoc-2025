...
def main():
  ...
  while pq:
    ...
    # check if we have reached the end and we've traveled at least 4 to stop
    ...
    # only add next node to the priority queue if we've taken less than 10 steps
    ...
    # we can only turn if we've travelled at least 4 or if its the first square
    if n >= 4 or (r, c) == (0, 0):
